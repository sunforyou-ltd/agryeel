 ...
 *
 */
public class KaishuCompornent extends CommonWorkDiaryWork {
     ...
     * @param resultJson
     */
    public KaishuCompornent(Session session, ObjectNode resultJson) {
     ...
     * @param api
     */
    public KaishuCompornent(Session session, ObjectNode resultJson, Boolean api) {
