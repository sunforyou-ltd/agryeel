 ...
 *
 */
public class CommentCompornent extends CommonWorkDiaryWork {
     ...
     * @param resultJson
     */
    public CommentCompornent(Session session, ObjectNode resultJson) {
     ...
     * @param api
     */
    public CommentCompornent(Session session, ObjectNode resultJson, Boolean api) {
