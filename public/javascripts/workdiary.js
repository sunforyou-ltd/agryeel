...
//        }
  ...
  function MakeShukakuItem(jsonResult) {
      ...
      var syukakuInputCount = jsonResult["syukakuinputcount"];
      var index=0;
      if (workHistryBase != undefined) {
...
//      htmlString+= '</div>';
  ...
  function MakeHaikiItem(jsonResult) {
      ...
      htmlString+= '<div class="col s12 m8 offset-m2 l4 offset-l4 card-panel wd-panel">';
      htmlString+= '<div class="col s12 input-field wd">';
      htmlString+= '<span class="item-title">廃棄量</span><span id="G0005HaikiRyoSpan" class="item">' + jsonResult["haikiRyo"] + '</span><span class="item">Kg</span><i class="material-icons orange-text text-lighten-1 small right calcTarget" targetId="G0005HaikiRyo">keyboard</i>';
      htmlString+= '<input type="hidden" id="G0005HaikiRyo" value="' + jsonResult["haikiRyo"] + '"/>';
      htmlString+= '</div>';
      htmlString+= '</div>';
      htmlString+= '</div>';
      htmlString+= '</div>';
...
//      htmlString+= '</div>';
  ...
  function dataToJson() {
    ...
    case 20://廃棄作業
      ...
      checktarget.push({ "id" : "G0005HaikiRyo"      , "name" : "廃棄量"    , "json" : "haikiRyo"   , "check" : { "required"  : "1"}});
      break;
